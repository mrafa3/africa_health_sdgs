...
map.theme <- theme(text = element_text(family = "Avenir-Book", color = "black"), 
...
map.theme.small <- theme(text = element_text(family = "Avenir-Book", color = "black"), 
                   panel.background = element_rect(fill = "white"),
                   plot.background = element_rect(fill = "white"),
                   panel.grid = element_blank(),
...
(l_map_clust <- joined.world.map %>% 
  ...
  coord_map(xlim = c(-30, 60),
            ylim = c(39, -37)) + 
  labs(fill = '') + 
  #scale_fill_viridis_(na.value = 'lightgray') + 
  scale_fill_jco() + 
  map.theme + 
...
```{r}
ggsave("map_cluster.png", plot = l_map_clust, height = 10, width = 10, family="Avenir-Book", device='png')
```

```{r}
ggsave("map_cluster_islands.png", plot = s_map_plot_grid, height = 10, width = 2, family="Avenir-Book", device='png')
```
...
(l_map <- joined.world.map %>% 
  ...
  guides(fill = guide_legend(title.position = "top"),
         alpha = 'none') + 
  theme(legend.position = c(.04, .3)))
    #legend.title = element_text(size=9, family = "Avenir-Book", color = "black"),
        #legend.text = element_text(size=10, family = "Avenir-Book", color = "black")))
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_maternal_2030.png", plot = l_map, height = 10, width = 10, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_maternal_islands.png", plot = s_map_plot_grid, height = 10, width = 2, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_neonatal_2030.png", plot = map_neonatal_afr, height = 10, width = 10, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_neonatal_islands.png", plot = s_map_neonatal_plot_grid, height = 10, width = 2, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_u5mr_2030.png", plot = map_u5mr_afr, height = 10, width = 10, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_u5mr_islands.png", plot = s_map_u5mr_plot_grid, height = 10, width = 2, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_ncds_2030.png", plot = map_ncds_afr, height = 10, width = 10, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_ncds_islands.png", plot = s_map_ncds_plot_grid, height = 10, width = 2, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_traff_2030.png", plot = map_traff_afr, height = 10, width = 10, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_traff_islands.png", plot = s_map_traff_plot_grid, height = 10, width = 2, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_malaria_2030.png", plot = map_malaria_dr_afr, height = 10, width = 10, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_malaria_islands.png", plot = s_map_malaria_plot_grid, height = 10, width = 2, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_aids_2030.png", plot = map_aids_dr_afr, height = 10, width = 10, family="Avenir-Book", device='png')
```
...
```{r}
#ggsave("map_test.pdf", plot = l_map, height = 20, width = 8, family="Avenir-Book", device=cairo_pdf)
ggsave("map_aids_islands.png", plot = s_map_aids_plot_grid, height = 10, width = 2, family="Avenir-Book", device='png')
```
